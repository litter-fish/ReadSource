...
public class Leader {
    ...
    void lead() throws IOException, InterruptedException {
        ...
        try {
            ...
            // new followers.
            // leader与其他服务器通信通过 LearnerHandler 线程进行
            cnxAcceptor = new LearnerCnxAcceptor();
            cnxAcceptor.start();
            
            readyToStart = true;
            // 生成新的epoch，这边会通过wait和notifyAll确保超过半数learner服务器向Leader进行了注册
            ...
            // acknowledged
            try {
                // 等待半数Learner服务器对NEWLEADER信息的ACK响应
    ...
    public long getEpochToPropose(long sid, long lastAcceptedEpoch) throws InterruptedException, IOException {
        synchronized(connectingFollowers) {
            ...
            // learner服务器的epoch比leader服务器的epoch大
